...
description: "Gera posts, carousels e anúncios (Ads) com identidade visual da Global Citizen Solutions. Cobre carousel multi-slide para Instagram/LinkedIn, posts de imagem única, e ads para Google Ads (Square 1200×1200, Landscape 1200×628) e Meta Ads (Vertical 1080×1920, Square 1080×1080). Triggers: carousel, post, instagram carousel, linkedin carousel, slide post, carousel GCS, google ads, meta ads, anúncio, ads GCS, social media GCS, imagem redes sociais, conteúdo GCS"
allowed-tools: Bash(*)
---

# Social Media & Ads — Global Citizen Solutions

Gera posts, carousels e anúncios com identidade visual GCS. Suporta **Posts** (imagem única ou carrossel) e **Ads** (Google Ads e Meta Ads). Slides e anúncios renderizados com **Playwright** e exportados como PNG/PDF.
...
O fluxo bifurca-se logo na primeira pergunta:

---

> **Pergunta 1 — Tipo de conteúdo:**
> 📣 **"É um Post para redes sociais ou um Anúncio (Ads)?"**

---

### 🅐 Se responder **Post**

> **Pergunta 1a — Formato do post:**
> 🖼️ **"É um post de imagem única ou um carrossel?"**
> - *Post de imagem única* → gera apenas Slide 1 (Cover/Hook)
> - *Carrossel* → gera múltiplos slides com os Tipos 1–5

> **Pergunta 1b — Imagem de capa (obrigatória):**
> 📎 **"Pode enviar a foto da capa?"**
> *(Aguardar upload. ⛔ Não avançar sem receber a imagem.)*

> **Pergunta 1c — Imagens adicionais (só carrossel, opcional):**
> 🖼️ **"Há mais alguma imagem que queira usar nos outros slides?"**
> *(Sem imagens → Slide 3 branco em todo o conteúdo. Com imagens → Slide 2 nos slides com foto.)*

> **Pergunta 1d — Plataforma:**
> 📱 **"Para qual plataforma — Instagram, LinkedIn, Twitter/X, Facebook, ou todas?"**

**⛔ Só avançar para o Passo 2 depois de receber resposta às 4 perguntas.** A imagem de capa é sempre obrigatória.

---

### 🅑 Se responder **Ads**

> **Pergunta 1a — Plataforma de anúncio:**
> 🎯 **"É Google Ads ou Meta Ads?"**

> **Pergunta 1b — Imagem (obrigatória):**
> 📎 **"Pode enviar a imagem do anúncio?"**
> *(Aguardar upload. ⛔ Não avançar sem receber a imagem.)*

> **Pergunta 1c — Formato(s) a gerar:**
> *(Apresentar as opções conforme a plataforma escolhida — ver tabela abaixo. Pode seleccionar mais do que um.)*
>
> **Google Ads:**
> - Square: 1200 × 1200 px
...
> **Pergunta 1d — Copy do anúncio:**
> ✍️ **"Qual é a overline (tema em maiúsculas) e o headline principal?"**
> *(Overline = ex: "PORTUGAL GOLDEN VISA" | Headline = ex: "Secure your family's future." Máx. 10 palavras.)*
> *(Opcional: texto de corpo — Heebo 300, breve, máx. 20 palavras. Só disponível em formatos verticais.)*

**⛔ Só avançar para o Passo 2 depois de receber resposta às 4 perguntas.** A imagem é sempre obrigatória.

---

### Tabela de saída — Post

| Tipo | Slides gerados | Dimensões |
|---|---|---|
| **Post único** | Apenas Slide 1 (Cover/Hook) | 1080 × 1350 px |
| **Carrossel Instagram/LinkedIn** | Slide 1 + conteúdo + Slide 5 (CTA) | 1080 × 1350 px |
| **Carrossel Twitter/X ou Facebook** | Idem acima | 1080 × 1080 px |

### Tabela de saída — Ads

| Plataforma | Formato | Dimensões | Ficheiro |
|---|---|---|---|
| Google Ads | Square | 1200 × 1200 px | `[tema]_google_square.png` |
| Google Ads | Landscape | 1200 × 628 px | `[tema]_google_landscape.png` |
| Meta Ads | Vertical | 1080 × 1920 px | `[tema]_meta_vertical.png` |
| Meta Ads | Square | 1080 × 1080 px | `[tema]_meta_square.png` |

### Template de referência — Post (carrossel)

O carousel usa o template do repositório GCS como base. Este template tem **5 tipos de slide** fixos:
...
**Regra central:** o conteúdo escrito vai sempre em **Slide 3 (branco)**. O Slide 2 só se usa quando existe uma foto relevante fornecida pelo utilizador.

---

### Forma A — Briefing (tema / intenção)
O utilizador descreve o tema, objetivo e plataforma. Claude propõe a estrutura completa.
...
O utilizador envia o conteúdo já escrito. Claude mapeia cada bloco para o tipo correcto e apresenta o Plano para aprovação.

**Em ambos os casos, o Passo 2 é obrigatório antes de gerar qualquer conteúdo.**
...
Se o utilizador pediu múltiplos formatos → gerar todos e entregar em ZIP: `[tema]_ads.zip`.
...
> — Ajustar algum slide / anúncio
> — Gerar outro formato (ex: landscape a partir do square)
> — Adaptar para outra plataforma
> — Criar a legenda para publicação
> — Iniciar um novo carousel ou anúncio"
...
<!-- SLIDE TIPO 3 · Content White — MODO TEXTO -->
<!-- Usar quando: ponto de valor descritivo, contexto narrativo, dica editorial -->
<!-- Logo: GCS-Symbol-Blue — sem círculo CSS -->
...
<!-- SLIDE TIPO 3 · Content White — MODO VISUAL -->
<!-- Usar quando: dados numéricos, comparações, rankings, processos, listas paralelas -->
<!-- Claude gera o asset visual em SVG/HTML inline dentro da área de conteúdo -->
<!-- Área disponível: top:380px → bottom:60px (≈910px altura útil), padding 0 64px (952px largura) -->
<div style="position:relative; width:1080px; height:1350px; background:#fff; overflow:hidden;">
  <div style="position:absolute; top:44px; left:44px;">
    <img src="{LOGO_BLUE}" style="width:72px; height:72px; object-fit:contain;" alt="GCS">
  </div>
  <!-- Heading curto acima do asset (overline opcional) -->
  <div style="position:absolute; top:380px; left:0; right:0; padding:0 64px; display:flex; flex-direction:column; gap:24px;">
    <p style="font-family:'Heebo',sans-serif; font-size:18px; font-weight:600; color:#3F8CFF; letter-spacing:0.13em; text-transform:uppercase;">[OVERLINE — opcional]</p>
    <h2 style="font-family:'Yrsa',serif; font-size:60px; font-weight:400; color:#000957; line-height:1.08; letter-spacing:-0.01em;">[HEADING CURTO]</h2>
    <!-- ↓ Asset visual gerado por Claude aqui ↓ -->
    <!-- Exemplos: tabela, gráfico de barras, stat cards, timeline, lista estilizada -->
    <!-- Paleta: #000957 · #3F8CFF · #6b7280 · #e5e7eb | border-radius:0 | sem sombras -->
    [ASSET_VISUAL_SVG_OU_HTML]
  </div>
</div>
...
# No início de cada geração (Post OU Ads):
LOGO_WHITE          = fetch_logo_b64("GCS-Symbol-White.svg")      # Slides 1, 2, 5 e Ads
LOGO_BLUE           = fetch_logo_b64("GCS-Symbol-Blue.svg")       # Slide 3
LOGO_WORDMARK_BLUE  = fetch_logo_b64("GCS-Secondary-Blue.svg")    # Slide 4 rodapé
LOGO_WORDMARK_WHITE = fetch_logo_b64("GCS-Secondary-White.svg")   # Ads rodapé
...
### Logos por slide/formato (resumo)

| Contexto | Logo | Tamanho | Posição |
|---|---|---|---|
| Slide 1 — Cover | `GCS-Symbol-White` | 72px | `top:44px; left:44px` |
| Slide 2 — Content+Image | `GCS-Symbol-White` | 72px | `top:44px; left:44px` (sobre foto) |
| Slide 3 — Content White | `GCS-Symbol-Blue` | 72px | `top:44px; left:44px` |
| Slide 4 — Quote | `GCS-Secondary-Blue` (wordmark azul) | height:32px | `bottom:52px` centrado |
| Slide 5 — CTA Dark | `GCS-Symbol-White` | 104px | centrado verticalmente |
| **Ads — todos os formatos** | `GCS-Symbol-White` (top-left) + `GCS-Secondary-White` (rodapé) | 4.4% da largura + altura proporcional | top-left + bottom-centre |
...
Templates no repositório: `https://github.com/vtorres-gcs/gcs-design-system/tree/main/templates`

| Template | Ficheiro | Dimensões |
|---|---|---|
...
### Anatomia do template (extraída dos ficheiros .dc.html)

**Gradiente de fundo — igual em todos os 4 formatos:**
```css
background: linear-gradient(180deg, rgba(0,9,87,0.1) 12.41%, rgb(0,9,87) 86.27%),
            url('./assets/background.jpg') center/cover no-repeat;
```
Quando o utilizador fornece uma foto → substituir `url('./assets/background.jpg')` pelo data URI base64 da foto.

**Campos do template:**
- `{{ title }}` — título principal. Suporta quebras de linha com `\n` (CSS: `white-space:pre-line`). Yrsa 400.
- `{{ subtitle }}` — opcional. Usado tipicamente para URL do site (`globalcitizensolutions.com`). Yrsa 400, `rgba(255,255,255,0.8)`.
- `{{ showSubtitle }}` — boolean. Se `false`, o subtitle não aparece.

**Logo — `GCS-Secondary-White` (wordmark completo em branco):**
- Google Square, Google Landscape, Meta Square → **rodapé** (bottom, centrado)
- Meta Vertical → **topo** do bloco de conteúdo (acima do título)

### Especificações tipográficas por formato

| Formato | Título (font-size) | Título (line-height) | Subtítulo (font-size) | Wordmark | Footer padding |
|---|---|---|---|---|---|
...
| Meta Vertical 1080×1920 | **100px** | 0.9 | 40px | 388×24px (topo) | — |

**Padding do bloco de conteúdo:** `60px 125px` em todos os formatos (Google Landscape e Square, Meta Square).
**Meta Vertical** tem padding diferente: container `padding:0 60px`, inner `padding:60px 125px`.

### Templates HTML prontos a usar
...
<div style="width:1200px;height:1200px;overflow:hidden;position:relative;display:flex;flex-direction:column;">
  <!-- Fundo: gradiente Night Blue + foto do utilizador -->
...
<!-- ═══════════════════════════════════════════════════════
     ...
     ⚠️ DIFERENTE: wordmark NO TOPO (acima do título), não no rodapé
     ═══════════════════════════════════════════════════════ -->
<div style="width:1080px;height:1920px;overflow:hidden;position:relative;display:flex;flex-direction:column;padding:0 60px;align-items:center;justify-content:center;box-sizing:border-box;">
  ...
  <div style="position:relative;z-index:1;flex:1;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:60px 125px;gap:40px;box-sizing:border-box;align-self:stretch;">
    <!-- Wordmark NO TOPO — diferença crítica do formato Vertical -->
...
### Função Python para gerar todos os Ads

```python
import base64, tarfile, io, urllib.request
from pathlib import Path

# Carregar logos e fontes (Yrsa apenas — os Ads não usam Heebo)
...
def build_ad(format_name: str, title: str, subtitle: str,
    ...
    subtitle: ex 'globalcitizensolutions.com' — usar None para omitir
    """
    SPECS = {
...
# Exemplo de uso — gerar todos os formatos pedidos
AD_FORMATS = {
...
for fmt, (w, h) in AD_FORMATS.items():
    html = build_ad(
        format_name=fmt,
        title=title,           # ex: "Portugal Golden Visa:\nPath to EU Residency"
        subtitle=subtitle,     # ex: "globalcitizensolutions.com" ou None
        photo_data_uri=USER_PHOTO_DATA_URI,
        logo_wm=LOGO_WORDMARK_WHITE,
        fonts_css=FONTS_CSS,   # Yrsa embebido via fontsource
    )
    Path(f"/home/claude/{slug}_{fmt}.html").write_text(html, encoding="utf-8")
```

### Notas importantes sobre o título (`title`)

- Usar `\n` no título para controlar quebras de linha (CSS `white-space:pre-line` activo)
- Para landscape, o título deve ser mais curto (sem quebras ou com 1 quebra apenas)
- Sugestão de comprimento: Square/Vertical → máx. 5 palavras por linha; Landscape → máx. 7 palavras totais
- O subtítulo é normalmente `globalcitizensolutions.com` — perguntar ao utilizador se quer outro texto ou nenhum

### Renderizar Ads com Playwright
...
**Slide Tipo 3 — Content White:**
- Fundo branco puro — **nunca gradiente neste tipo**
- Logo: `GCS-Symbol-Blue`, `top:44px; left:44px`
- Overline opcional: Heebo 600, Electric Blue `#3F8CFF`, uppercase, letter-spacing 0.13em
- Heading: Yrsa 400, Night Blue `#000957`, 74px, line-height 1.08
- Conteúdo começa em `top:380px` — logo fica no topo sem sobreposição

**Slide Tipo 3 — Modos de layout (Claude decide com base no conteúdo):**

O Slide 3 suporta dois modos. Claude escolhe o mais adequado ao conteúdo, sem precisar de autorização:

| Modo | Quando usar | O que inclui |
|---|---|---|
| **Texto** | Ponto de valor descritivo, contexto narrativo, dica editorial | Overline + Heading + Body (máx. 40 palavras) |
| **Visual** | Dados numéricos, comparações, rankings, processos, cronologias, listas paralelas | Asset visual gerado em SVG/HTML inline + heading curto |

**Modo Visual — assets que Claude pode criar:**

- **Gráfico de barras** — comparação de valores entre países, anos, programas
- **Gráfico circular / donut** — distribuição percentual (ex: perfil de investidores por país de origem)
- **Tabela de comparação** — lado a lado (ex: Portugal vs. Malta vs. Grécia)
- **Timeline horizontal** — etapas de um processo com datas (ex: processo de candidatura ao Golden Visa)
- **Lista numerada estilizada** — ranking com ícones ou números grandes em Electric Blue
- **Stat cards** — 2–4 estatísticas em destaque (número grande Yrsa + label Heebo)
- **Infográfico de processo** — setas ou conectores entre etapas
- **Mapa simplificado** — SVG estilizado (Schengen, Portugal, etc.) quando geograficamente relevante

**Regras dos assets visuais no Slide 3:**

```
Paleta obrigatória:       Night Blue #000957 · Electric Blue #3F8CFF · Cinza texto #6b7280
                          Fundo sempre branco #ffffff — nunca cor de fundo nos blocos
Fontes:                   Números/valores grandes → Yrsa 400
                          Labels, legendas, eixos → Heebo 300/400
Cantos:                   border-radius:0 em TUDO (gráficos, tabelas, cards, barras)
                          Excepção: círculos decorativos (border-radius:50%)
Barras e linhas:          Cor primária #000957 · Cor de destaque #3F8CFF · Neutro #e5e7eb
Separadores:              1px solid #e5e7eb — nunca sombras
Espaçamento:              Múltiplos de 4px (4, 8, 12, 16, 24, 32, 48)
Largura máx. do asset:    952px (1080 - 64px padding cada lado)
Área disponível:          De top:380px até bottom:60px → ~910px de altura útil
```
...
## Slide 3 — Assets Visuais (referência de implementação)

Claude gera os assets abaixo directamente em HTML/SVG inline, dentro da área de conteúdo do Slide 3 (Modo Visual). Todos usam os tokens GCS: `#000957`, `#3F8CFF`, `#6b7280`, `#e5e7eb`. `border-radius:0` em tudo.

### Stat Cards (2–4 estatísticas em destaque)

```html
<!-- 3 stat cards — usar para dados impactantes isolados -->
<div style="display:flex; gap:16px; margin-top:32px;">
  <div style="flex:1; padding:32px 24px; border:1px solid #e5e7eb; display:flex; flex-direction:column; gap:12px;">
    ...
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:400; color:#6b7280; line-height:1.4;">Investimento mínimo</span>
  </div>
  <div style="flex:1; padding:32px 24px; border:1px solid #e5e7eb; display:flex; flex-direction:column; gap:12px;">
    <span style="font-family:'Yrsa',serif; font-size:72px; font-weight:400; color:#3F8CFF; line-height:1;">27</span>
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:400; color:#6b7280; line-height:1.4;">Países Schengen</span>
  </div>
  <div style="flex:1; padding:32px 24px; border:1px solid #e5e7eb; display:flex; flex-direction:column; gap:12px;">
    <span style="font-family:'Yrsa',serif; font-size:72px; font-weight:400; color:#000957; line-height:1;">5+1</span>
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:400; color:#6b7280; line-height:1.4;">Anos para cidadania</span>
  </div>
</div>
```
...
```html
<!-- Barras horizontais — comparação entre países/programas -->
<div style="display:flex; flex-direction:column; gap:20px; margin-top:32px;">
  ...
  <div style="display:flex; flex-direction:column; gap:8px;">
    <div style="display:flex; justify-content:space-between; align-items:baseline;">
      <span style="font-family:'Heebo',sans-serif; font-size:24px; font-weight:400; color:#000957;">Grécia</span>
...
```html
<!-- Tabela lado a lado — usar para comparar programas, países, opções -->
<div style="margin-top:32px; border:1px solid #e5e7eb;">
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; background:#000957;">
    <div style="padding:20px 24px;">
      <span style="font-family:'Heebo',sans-serif; font-size:20px; font-weight:500; color:#fff; letter-spacing:0.05em;">CRITÉRIO</span>
    </div>
  ...
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; border-top:1px solid #e5e7eb;">
    <div style="padding:20px 24px;">
      <span style="font-family:'Heebo',sans-serif; font-size:22px; color:#6b7280;">Investimento</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#000957;">€500k</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#6b7280;">€690k</span>
    </div>
  </div>
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; border-top:1px solid #e5e7eb;">
    <div style="padding:20px 24px;">
      <span style="font-family:'Heebo',sans-serif; font-size:22px; color:#6b7280;">Cidadania</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#000957;">5 anos</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#6b7280;">36 meses</span>
    </div>
  </div>
  <div style="display:grid; grid-template-columns:1fr 1fr 1fr; border-top:1px solid #e5e7eb;">
    <div style="padding:20px 24px;">
      <span style="font-family:'Heebo',sans-serif; font-size:22px; color:#6b7280;">Schengen</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#3F8CFF;">✓ Sim</span>
    </div>
    <div style="padding:20px 24px; border-left:1px solid #e5e7eb;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#3F8CFF;">✓ Sim</span>
    </div>
...
```html
<!-- Timeline horizontal — etapas de um processo -->
<div style="display:flex; align-items:flex-start; gap:0; margin-top:40px;">
  <!-- Etapa 1 -->
  <div style="flex:1; display:flex; flex-direction:column; align-items:center; gap:16px;">
    <div style="width:56px; height:56px; background:#000957; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#fff;">1</span>
    </div>
    <div style="width:100%; height:2px; background:#000957; margin-top:27px;"></div>
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:500; color:#000957; text-align:center;">Candidatura</span>
    <span style="font-family:'Heebo',sans-serif; font-size:18px; color:#6b7280; text-align:center;">1–2 semanas</span>
  </div>
  <!-- Etapa 2 -->
  <div style="flex:1; display:flex; flex-direction:column; align-items:center; gap:16px;">
    <div style="width:56px; height:56px; background:#3F8CFF; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
      <span style="font-family:'Yrsa',serif; font-size:28px; color:#fff;">2</span>
    </div>
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:500; color:#000957; text-align:center;">Aprovação</span>
    <span style="font-family:'Heebo',sans-serif; font-size:18px; color:#6b7280; text-align:center;">3–6 meses</span>
  </div>
  <!-- Etapa 3 -->
  <div style="flex:1; display:flex; flex-direction:column; align-items:center; gap:16px;">
    <div style="width:56px; height:56px; background:#000957; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
    ...
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:500; color:#000957; text-align:center;">Residência</span>
    <span style="font-family:'Heebo',sans-serif; font-size:18px; color:#6b7280; text-align:center;">Emitida</span>
  </div>
  <!-- Etapa 4 -->
  <div style="flex:1; display:flex; flex-direction:column; align-items:center; gap:16px;">
    <div style="width:56px; height:56px; background:#3F8CFF; display:flex; align-items:center; justify-content:center; flex-shrink:0;">
    ...
    <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:500; color:#000957; text-align:center;">Cidadania</span>
    <span style="font-family:'Heebo',sans-serif; font-size:18px; color:#6b7280; text-align:center;">Após 5 anos</span>
  </div>
</div>
```

### Lista Numerada Estilizada (Ranking)

```html
<!-- Lista numerada com números grandes — usar para rankings, top N, passos -->
<div style="display:flex; flex-direction:column; gap:4px; margin-top:24px;">
  <div style="display:flex; align-items:center; gap:32px; padding:24px 0; border-bottom:1px solid #e5e7eb;">
    ...
    <div style="display:flex; flex-direction:column; gap:6px;">
      ...
      <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:300; color:#6b7280;">Passport Index Score: 189 destinos</span>
    </div>
  </div>
  <div style="display:flex; align-items:center; gap:32px; padding:24px 0; border-bottom:1px solid #e5e7eb;">
    ...
    <div style="display:flex; flex-direction:column; gap:6px;">
      ...
      <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:300; color:#6b7280;">Passport Index Score: 188 destinos</span>
    </div>
  </div>
  <div style="display:flex; align-items:center; gap:32px; padding:24px 0;">
    ...
    <div style="display:flex; flex-direction:column; gap:6px;">
      <span style="font-family:'Heebo',sans-serif; font-size:30px; font-weight:500; color:#000957;">Grécia</span>
      <span style="font-family:'Heebo',sans-serif; font-size:22px; font-weight:300; color:#6b7280;">Passport Index Score: 187 destinos</span>
    </div>
  </div>
</div>
```

### Como Claude decide entre Texto e Visual

```
Conteúdo com números, percentagens, rankings, comparações entre ≥2 itens
  → Modo Visual

Conteúdo narrativo, explicativo, dica editorial, ponto de valor único
  → Modo Texto

Dúvida? Verificar: "ficaria mais claro numa tabela/gráfico do que num parágrafo?"
  → Se sim → Modo Visual
```
